...
export const stateMessages = {
  en: {
    ...
    mode: 'Unknown saved VS Code mode. Expected interactive, autonomous or autopilot.',
  ...
  fr: {
    ...
    mode: 'Mode VS Code enregistré inconnu. Valeurs attendues : interactive, autonomous ou autopilot.',
